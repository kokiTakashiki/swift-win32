...
@main
final class TeatAppDemo: ApplicationDelegate, SceneDelegate {
  var window: Window!
...
extension TeatAppDemo: TableViewDataSource {
...
extension TeatAppDemo: PickerViewDataSource {
...
extension TeatAppDemo: PickerViewDelegate {
